...
const props = defineProps<{
  /** Pares [clave, etiqueta] en orden. */
  tabs: [K, string][]
  /** Nombre accesible de la lista de pestañas. */
  label: string
  /** Prefijo para los id de cada pestaña (`${base}-tab-${clave}`). */
  base: string
  /** Contadores opcionales por clave (se ocultan cuando son 0 o undefined). */
...
// Patrón WAI-ARIA de tabs con activación automática: flechas mueven selección y
// foco; Home/End van al extremo; se envuelve en los bordes.
