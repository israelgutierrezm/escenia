    ...
    <template v-else-if="event">
      <div class="head panel">
        ...
        <div class="head-links">
          ...
          <RouterLink :to="{ name: 'event-content', params: { id } }" class="head-link">
            Contenido ›
          </RouterLink>
          <RouterLink :to="{ name: 'event-education', params: { id } }" class="head-link">
            Educación ›
          </RouterLink>
          <RouterLink :to="{ name: 'event-agenda', params: { id } }" class="head-link">
            Agenda y expo ›
          </RouterLink>
          <RouterLink :to="{ name: 'event-ai', params: { id } }" class="head-link">
            IA ›
          </RouterLink>
        </div>
      </div>
